...
class HomegamesRoot {
    ...
    constructor(game, isDashboard, profiling) {
        ...
        this.renderTimes = [];
        this.game = game;
        // if (this.game.constructor.metadata() && this.game.constructor.metadata().squishVersion) {
        //     const squishVersion = squishMap[this.game.constructor.metadata().squishVersion];
